from pimly.models.carrier.abc.pdf import BaseInvoicePDF, arabic_text
...
class EgyptInvoicePDF(BaseInvoicePDF):
...
class ArabEmiratesInvoicePDF(SaudiArabiaInvoicePDF):
    pass
